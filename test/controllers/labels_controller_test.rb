...
class LabelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create label" do
    assert_difference('Label.count') do
      post labels_url, params: { label: { new_label: @label.new_label, task_id: @label.task_id } }
    end
  ...
  test "should update label" do
    patch label_url(@label), params: { label: { new_label: @label.new_label, task_id: @label.task_id } }
